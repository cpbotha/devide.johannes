...
BASENAME = "TemplateWorkbench"
GIT_REPO = "https://thomas@hg.graphics.tudelft.nl/vis/thomas/TemplateWorkbench"

dependencies = ['CMake', 'Qt', 'VTK_QT_58']
                  
class TWB(InstallPackage):
    ...
    def configure(self):
        if os.path.exists(
           ...
           utils.output("Template Workbench build already configured.")
           return
